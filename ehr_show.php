...
$templates = $ehrserver->get_templates('6b92f9a8-856d-4f9d-9936-d908d0baae08');
?><!doctype html>
<html lang="bg">
    <head>
        <meta charset="utf-8">
        ...
        <title>Детайли за пациент: <?= $_GET['uid'] ?></title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <h3>Издадени Електронни рецепти на пациент </h3>

                    <table class="table" id="documents">
                        <thead>
                            <tr>
                                <th scope="col">№</th>
                                <th scope="col">Идентификатор рецепта</th>
