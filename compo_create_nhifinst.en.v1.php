...
if(isset($_POST['submit']))
{
  ...
  $allowSub=$params['/activities[at0001]/items[at0004]/items[at0016]/value']=='on'? '1' : '0';

  $mappings = array(
    '[[HIER_OBJECT_ID:::UUID]]' => generate_uuid(),
    ...
    '[[typeOfPrescription:::DV_ORDINAL]]' => $params['/activities[at0001]/items[at0002]/items[at0005]/value'],
	'[[prescriptionNo:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0008]/value'],
	'[[prescriptionDate:::DV_DATE]]' => $params['/activities[at0001]/items[at0002]/items[at0009]/value'],
	'[[doctorUin:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0017]/items[at0018]/value'],
	'[[doctorSpecialty:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0017]/items[at0021]/value'],
	'[[heRegistrationNo:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0017]/items[at0019]/value'],
	'[[ambulatorySheetNo:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0017]/items[at0020]/value'],
	'[[ambSheetPrescriptionNo:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0017]/items[at0022]/value'],
	'[[EGN:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0003]/items[at0010]/value'],
	'[[prescriptionBookletNo:::DV_TEXT]]' => $params['/activities[at0001]/items[at0002]/items[at0003]/items[at0011]/value'],
	'[[drugNHIFCode:::DV_TEXT]]' => $params['/activities[at0001]/items[at0004]/items[at0012]/value'],
	'[[codeICD:::DV_TEXT]]' => $params['/activities[at0001]/items[at0004]/items[at0013]/value'],
	'[[prescribedQuantity:::DV_COUNT]]' => $params['/activities[at0001]/items[at0004]/items[at0023]/value'],
	'[[prescribedMeasure:::DV_ORDINAL]]' => $params['/activities[at0001]/items[at0004]/items[at0025]/value'],
	'[[numberOfDays:::DV_COUNT]]' => $params['/activities[at0001]/items[at0004]/items[at0024]/value'],
	'[[signatureRepeats:::DV_COUNT]]' => $params['/activities[at0001]/items[at0004]/items[at0032]/value'],
	'[[signatureQuantity:::DV_COUNT]]' => $params['/activities[at0001]/items[at0004]/items[at0031]/value'],
	'[[signatureOccurrence:::DV_ORDINAL]]' => $params['/activities[at0001]/items[at0004]/items[at0034]/value'],
//	'[[Allow susbstitution?:::DV_BOOLEAN]]' => $params['/activities[at0001]/items[at0004]/items[at0016]/value'],
 ...
 <div class="container">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4 col-md-12">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <select id="1"
                                                    class="DV_ORDINAL form-control" name="/activities[at0001]/items[at0002]/items[at0005]/value">
                                    ...
                                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="2" type="number" min="1" max="999999" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0008]/value" />
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="datepicker" placeholder="Дата:"
                                                   class="DV_DATE form-control" name="/activities[at0001]/items[at0002]/items[at0009]/value" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="4" type="number" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0017]/items[at0018]/value" />
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="5" type="number" min="0" max="99" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0017]/items[at0021]/value" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="6" type="number" 
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0017]/items[at0019]/value" />
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <div class="input-group mb-1
                                            ...
                                            <input id="7" type="number" min="1" max="999999" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0017]/items[at0020]/value" />
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="8" type="number" min="1" max="999999" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0017]/items[at0022]/value" />
                                        </div>
                                    </div>
                                </div>
                                <hr style="background-color: #17A2B8; box-shadow: 0 0 1px grey;">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="9" type="number" min="1000000000" max="9999999999" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0003]/items[at0010]/value" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="10" type="number" min="1" max="9999" step="1"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0002]/items[at0003]/items[at0011]/value" />
                                        </div>
                                    </div>
                                </div>
                                <hr style="background-color: #17A2B8; box-shadow: 0 0 1px grey;">
                                    ...
                                    <div class="form-group col-md-4 col-lg-3">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="11" type="text" maxlength="5"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0004]/items[at0012]/value" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-3">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="13" type="text" maxlength="5"
                                                   class="DV_TEXT form-control" name="/activities[at0001]/items[at0004]/items[at0013]/value" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="14" type="number" min="1" max="999" step="1"
                                                   class="DV_COUNT form-control" name="/activities[at0001]/items[at0004]/items[at0023]/value" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        <div class="input-group mb-1
                                            ...
                                            <select id="15"
                                                    class="DV_ORDINAL form-control" name="/activities[at0001]/items[at0004]/items[at0025]/value">
                                                <option value="">-</option>
                                    ...
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="16" type="number" min="1" max="999" step="1"
                                                   class="DV_COUNT form-control" name="/activities[at0001]/items[at0004]/items[at0024]/value" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <input id="17" type="number" min="1" max="99" step="1"
                                                   class="DV_COUNT form-control" name="/activities[at0001]/items[at0004]/items[at0032]/value" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        <div class="input-group mb-1
                                            ...
                                            <input id="18" type="number" min="1" max="999"
                                                   class="DV_COUNT form-control" name="/activities[at0001]/items[at0004]/items[at0031]/value" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        <div class="ELEMENT input-group mb-1
                                            ...
                                            <select id="19"
                                                    class="DV_ORDINAL form-control" name="/activities[at0001]/items[at0004]/items[at0034]/value">
                                                <option value="">-</option>
        ...
        <script>
                                        ...
                                        $('#datepicker').datepicker({
                                            ...
                                            format: 'yyyymmdd' //bg date format
                                        });
        </script>
